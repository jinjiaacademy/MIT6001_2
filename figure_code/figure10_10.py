...
class Mortgage(object):
    ...
    def __init__(self, loan, ann_rate, months):
        ...
        Create a new mortgage of size loan, duration months, and
...
def compare_mortages(amt, years, fixed_rate, pts, pts_rate,
...
compare_mortages(amt=200000, years=30, fixed_rate=0.035,
